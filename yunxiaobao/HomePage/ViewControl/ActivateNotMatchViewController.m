//
//  ActivateNotMatchViewController.m
//  yunxiaobao
//
...
#import "ActivateNotMatchViewController.h"
#import "AllActivateMachineTableViewCell.h"

@interface ActivateNotMatchViewController ()<UITableViewDelegate, UITableViewDataSource>

@end

@implementation ActivateNotMatchViewController
...
-(void)freshTableView{
    [self urlHeadStr:AppPosTypeURL urlStr:UrlAppPosType parameters:[NSDictionary dictionaryWithObjectsAndKeys:self.userInfoModel.user_id, @"a_user_id", @"0", @"a_type", nil] Success:^(NSDictionary *obj) {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    allActivateMachineTableViewCell.machineActiveNotSNString = [NSString stringWithFormat:@"SN：%@", model.a_sn];
    allActivateMachineTableViewCell.machineActiveTypeString = model.a_type;
    allActivateMachineTableViewCell.appPosModel = model;
