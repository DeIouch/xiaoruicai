//
//  ActivatedMatchViewController.m
//  yunxiaobao
//
...
#import "ActivatedMatchViewController.h"
#import "AllActivateMachineTableViewCell.h"

@interface ActivatedMatchViewController ()<UITableViewDelegate, UITableViewDataSource>

@end

@implementation ActivatedMatchViewController
...
-(void)freshTableView{
    [self urlHeadStr:AppPosTypeURL urlStr:UrlAppPosType parameters:[NSDictionary dictionaryWithObjectsAndKeys:self.userInfoModel.user_id, @"a_user_id", @"1", @"a_type", nil] Success:^(NSDictionary *obj) {
