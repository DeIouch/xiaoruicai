//
//  ActivatingMatchViewController.m
//  yunxiaobao
//
...
#import "ActivatingMatchViewController.h"
#import "AllActivateMachineTableViewCell.h"

@interface ActivatingMatchViewController ()<UITableViewDelegate, UITableViewDataSource>

@end

@implementation ActivatingMatchViewController
...
-(void)freshTableView{
    [self urlHeadStr:AppPosTypeURL urlStr:UrlAppPosType parameters:[NSDictionary dictionaryWithObjectsAndKeys:self.userInfoModel.user_id, @"a_user_id", @"2", @"a_type", nil] Success:^(NSDictionary *obj) {
