//
//  MinePosBuyListViewController.m
//  yunxiaobao
//
...
#import "MinePosBuyListViewController.h"
#import "HomePageBuyedPosTableViewCell.h"
#import "HomePageApplyPosViewController.h"

@interface MinePosBuyListViewController ()<UITableViewDelegate, UITableViewDataSource, UITextViewDelegate>
...
@implementation MinePosBuyListViewController
...
-(void)noBuyUI{
    ...
    [self.backLabel addGestureRecognizer:[[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(goBackView)]];
}
