...
//        NSData *data = UIImageJPEGRepresentation(photos[idx], 0.5);
//        UIImage *resultImage = [UIImage imageWithData:UIImageJPEGRepresentation(photos[idx], 0.5)];
        
        ACMediaModel *model = [ACMediaModel imageInfoWithAsset:assets[idx] image:[UIImage imageWithData:UIImageJPEGRepresentation(photos[idx], 0.5)]];
